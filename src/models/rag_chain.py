...
class RAGChain:
    ...
    def query(self, query: str, top_k: int = 10):
        ...
        - Respond in the same language as the question. If the question is in Arabic, respond fully in Arabic. If in English, respond fully in English.
        - When responding in Arabic, use a gender-neutral tone. Avoid addressing the user directly.
        - Prefer passive or impersonal constructions such as: "يُخلط"، "يُوضع"، "يُخبز"، "يتم التقطيع"، إلخ.
